...
这是一个 GitHub Pages 静态网站，用来保存和展示 2026 年 8 月 19 日至 8 月 30 日的巴尔干三国自驾行程。
...
明确不去：黑山；克罗地亚的斯普利特、十六湖、萨格勒布；D3 不含啤酒厂。

交通：重庆 -> 贝尔格莱德 BEG；贝尔格莱德取车；杜布罗文克 DBV 还车；杜布罗文克 -> 重庆。
...
- D8，8 月 26 日：莫斯塔尔 -> 杜布罗文克。Pocitelj 可选，Gruz 入住，Pile Gate 傍晚初探。
- D9，8 月 27 日：杜布罗文克城墙日。古城墙、Stradun、Banje、Srd 山缆车可选。
- D10，8 月 28 日：杜布罗文克深度日。Lokrum 或 Cavtat。
- D11，8 月 29 日：杜布罗文克缓冲日。Ston 半日或古城补逛。
- D12，8 月 30 日：DBV 还车，飞回重庆。
...
3. 继续核对边境、租车跨境费、绿卡、单向还车费。
4. 后续如买到机票，需要把实际航班时间同步进 D1 和 D12。
5. 后续如订好 Airbnb，需要把住宿地址或区域同步到地图。
